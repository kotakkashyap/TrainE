...
<head>
    ...
    <script src="https://kit.fontawesome.com/e6c3b1ab9c.js" crossorigin="anonymous"></script>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="flex">
                <div class="pi-parent">
                    <div class="circle">
                        <div class="fa fa-stream fa-3x icon"></div>
                    </div>
                    <a class="pi-activity" id="pi-activity" href="ListOfStudents.php">List Of Students</a>
                </div>
                <div class="tps-parent">
                    <div class="circle1">
                        <div class="fa fa-sort-numeric-down-alt fa-3x icon"></div>
                    </div>
                    <a class="tps-activity" id="tps-activity" href="COAttainment.php">CO-Attainment</a>
                </div>
                <div class="theory-parent">
                    <div class="circle2">
                        <div class="fa fa-pencil fa-3x icon"></div>
                    </div>
                    <a class="theory-paper" id="theory-paper" href="StudentMarksCourseWise.php">Course Wise Marks</a>
                </div>
            </div>
        </div><!-- /.content-wrapper -->
        <!-- Main Footer -->
