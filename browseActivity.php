                    ...
                    if(flag == 0)
                    {
                        $.ajax({
                            ...
                            success: function(data, status){
                                var activityTable = "<table class='centered striped responsive-table'><thead><tr><td>Activity Id</td><td>Type</td><td>Domain</td><td>Course</td><td>Name Of Professor</td><td>View</td></tr></thead><tbody>";
                                $.each(data, function(i){
                                    ...
                                    typeRet = row.typeRet;
                                    activityTable = activityTable + "<tr><td>"+idRet+"</td><td>"+typeRet+"</td><td>"+domainRet+"</td><td>"+courseRet+"</td><td>"+nameRet+"</td><td><a href='ViewActivity.php?activityID="+idRet+"&activityType="+typeRet+"'>View</a></td>";
                                });
                                activityTable = activityTable + "</tbody></table>";
