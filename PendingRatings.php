                ...
                <div class="container">
                    ...
                    <table class="striped centered responsive-table">
                        ...
                        <tbody>
                            <?php
                                ...
                                $query = "SELECT * FROM givenreviews WHERE ACTIVITY_TYPE='PI' AND GIVENTO='$nameOfUser' AND STATUS='PENDING'";
                    ...
                    <table class="striped centered responsive-table">
                        ...
                        <tbody>
                            <?php
                                $nameOfUser = $_SESSION['username'];
                                $query = "SELECT * FROM givenreviews WHERE ACTIVITY_TYPE='TPS' AND GIVENTO='$nameOfUser' AND STATUS='PENDING'";
                                $result = mysqli_query($con ,$query);
                                while($row = mysqli_fetch_array($result))
                                {
                                    echo "<tr>";
                    ...
                    <table class="striped centered responsive-table">
                        ...
                        <tbody>
                            <?php
                                $nameOfUser = $_SESSION['username'];
                                $query = "SELECT * FROM givenreviews WHERE ACTIVITY_TYPE='THEORY_PAPER' AND GIVENTO='$nameOfUser' AND STATUS='PENDING'";
                                $result = mysqli_query($con ,$query);
                                while($row = mysqli_fetch_array($result))
                                {
                                    echo "<tr>";
