                ...
                $("#anotherButton").click(function(){
                    ...
                    if(flag == 0)
                    {
                        $.ajax({
                            ...
                            success: function(data, status){
                                var marksTable = "<table class='centered striped responsive-table'><thead><td>ENROLLMENT NUMBER</td><td>SEMESTER</td><td>COURSE</td><td>ASSIGNMENT1</td><td>ASSIGNMENT2</td><td>TEST</td><td>AVERAGE</td></thead><tbody>";
                                $.each(data, function(i){
                                    row = data[i];
                                    enroll = row.enroll;
                                    courseName = row.courseRet;
                                    ...
                                    test = row.testRet;
                                    avg = row.avgRet;
                                    marksTable = marksTable + "<tr><td>"+enroll+"</td><td>"+semName+"</td><td>"+courseName+"</td><td>"+assign1+"</td><td>"+assign2+"</td><td>"+test+"</td><td>"+avg+"</td>";
                                });
